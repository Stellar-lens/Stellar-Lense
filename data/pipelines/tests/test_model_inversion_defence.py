...
class TestLaplaceNoise:
    ...
    def test_output_perturbation_external_adds_noise(self):
        ...
        score = 50
        perturbed = _apply_output_perturbation(
            score, caller_id="api.user123", timestamp_bucket=1000
        )
    ...
    def test_output_perturbation_seeding_reproducible(self):
        ...
        p1 = _apply_output_perturbation(
            score, caller_id=caller_id, timestamp_bucket=timestamp_bucket
        )
        p2 = _apply_output_perturbation(
            score, caller_id=caller_id, timestamp_bucket=timestamp_bucket
        )
    ...
    def test_score_rounding_granularity(self):
        ...
        try:
            score = 77
            perturbed = _apply_output_perturbation(
                score, caller_id="api.test", timestamp_bucket=4000
            )

...
class TestQueryMethods:
    ...
    def test_match_scores_sorted(self, clean_registry):
        ...
        query_caps = ImporterCapability.STREAMING | ImporterCapability.BULK | ImporterCapability.PAGINATION
...
class TestValidationSystem:
    ...
    def test_validate_requirements_all_satisfied(
        self, clean_registry, sample_metadata
    ):
    ...
    def test_validate_requirements_missing_capability(
        self, clean_registry, sample_metadata
    ):
    ...
    def test_validate_requirements_missing_data_type(
        self, clean_registry, sample_metadata
    ):
...
class TestEdgeCases:
    ...
    def test_multiple_data_types_query(self, clean_registry):
        ...
        metadata = ImporterMetadata(
            ...
            capabilities=ImporterCapability.BULK,
            data_types=frozenset({DataType.TRADE, DataType.ORDERBOOK_EVENT, DataType.ACCOUNT_ACTIVITY}),
            sources=frozenset({DataSource.HORIZON_REST}),
        )

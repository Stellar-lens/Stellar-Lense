...
- [ ] Create non-root user `stellar_lense` (UID 1000) in the final stage; run the process as that user
...
- [ ] `docker inspect` shows process user is `stellar_lense`, not `root`

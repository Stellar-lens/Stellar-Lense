...
>
> - `cargo build -p stellar-lense-zk-verifier --target wasm32-unknown-unknown --release` succeeds.
> - `cargo test -p stellar-lense-zk-verifier` passes (23 tests: `mul_mod`/`add_mod`/`sub_mod`
...
- ✅ References (cargo-fuzz, libFuzzer, Soroban SDK, Stellar Lense docs)

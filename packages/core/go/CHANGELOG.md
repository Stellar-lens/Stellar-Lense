# Changelog — Stellar Lense Go SDK

All notable changes to the Stellar Lense Go SDK (`github.com/Stellar-lens/Stellar-Lense/go`)
are documented in this file.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.1.0/),
and this module adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
Releases are tagged `go/vX.Y.Z` (the `go/` prefix is required for Go submodule
tags) and installed with `go get github.com/Stellar-lens/Stellar-Lense/go@go/vX.Y.Z`.

This changelog is scoped to the `go/` directory only. Changes to the wider
`stellar-lense-core` repository are tracked in the [root CHANGELOG](../CHANGELOG.md).
...
[#340](https://github.com/Ledger-Lenz/StellarLense-core/pull/340)) and will ship
as `go/v0.1.0`.

### Added

- `Client` — context-aware HTTP client for the Stellar Lense REST API, constructed
...
- Typed error handling via `StellarLenseAPIError` (exposes `StatusCode`, `Detail`,
...
[Unreleased]: https://github.com/Stellar-lens/Stellar-Lense/commits/main/go
[0.1.0]: https://github.com/Stellar-lens/Stellar-Lense/commits/main/go

...
class RiskScoreRecord(Base):
    ...
    certified_robust: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True, default=None)
...
class ModelVersionRecord(Base):
    ...
    promotion_blocked_reason: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    training_metadata: Mapped[Optional[str]] = mapped_column(Text, nullable=True)

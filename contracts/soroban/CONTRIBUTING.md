# Contributing to Stellar Lense Contract

Thanks for your interest in improving the Stellar Lense on-chain risk score registry.
...
4. Make a small change (e.g., fix a typo or add a doc example):
   - Edit files inside `contracts/stellar-lense-score/`
...
3. Make your changes inside `contracts/stellar-lense-score/`.

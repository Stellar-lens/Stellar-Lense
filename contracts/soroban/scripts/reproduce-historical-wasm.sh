...
fixture_lock="$fixture_dir/stellar-lense-score-v3-8336828.Cargo.lock"
expected_wasm="$fixture_dir/stellar-lense-score-v3-8336828.wasm"
...
fixture_worktree="$(mktemp -d "${TMPDIR:-/tmp}/stellar_lense-v3-repro.XXXXXX")"
...
(
    ...
    RUSTC_BOOTSTRAP=1 \
        ...
        cargo +1.85.0 build \
            ...
            --locked
    wasm-opt target/wasm32-unknown-unknown/release/stellar_lense_score.wasm \
        -o stellar-lense-score-v3-8336828.wasm \
        -Oz \
...
reproduced_wasm="$fixture_worktree/stellar-lense-score-v3-8336828.wasm"

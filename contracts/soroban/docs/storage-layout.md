...
This document provides a comprehensive specification of the on-chain storage structure, keys, storage tiers, Time-to-Live (TTL) settings, and rent mechanics utilized in the Stellar Lense smart contract.
...
Stellar Lense dynamically extends the TTL of active keys to prevent unexpected archiving or expiration. However, how and when these extensions are triggered is critical to gas consumption:
...
To allow gas-free and infallible integrations from external smart contracts (e.g., AMM guards calling `query_risk_gate`), Stellar Lense provides separate **peek** read paths (e.g., `peek_score`, `peek_risk_band_state`, `peek_is_embargoed`). These functions perform direct reads without calling `extend_ttl`. 
> [!NOTE]
...
The following tables specify every key stored by Stellar Lense, mapped to its storage tier, TTL parameters, and purpose.
...
| `AdminSet` | Instance | N/A | N/A | The list of multi-sig admin co-signers. | [`MAX_ADMIN_SIGNERS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L92) |
...
| `ServiceSet` | Instance | N/A | N/A | The set of addresses authorized to co-sign score submissions. | [`MAX_SERVICE_SIGNERS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L89) |
...
| `RiskThreshold` | Instance | N/A | N/A | Global threshold above which scores trigger breach events. | [`DEFAULT_RISK_THRESHOLD`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L16) |
...
| `HistoryMaxDepth` | Instance | N/A | N/A | Depth of the `ScoreHistory` ring buffer. | [`DEFAULT_HISTORY_MAX_DEPTH`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L10), [`MAX_HISTORY_DEPTH`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L7) |
| `ContractVersion` | Instance | N/A | N/A | Semantic contract version. | [`CONTRACT_VERSION`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L29) |
| `PendingUpgrade` | Instance | N/A | N/A | Current locked-in `UpgradeProposal` for contract WASM upgrades. | - |
| `UpgradeDelay` | Instance | N/A | N/A | Delay in seconds between proposal and execution of WASM upgrades. | [`DEFAULT_UPGRADE_DELAY_SECS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L86) |
| `StalenessWindow` | Instance | N/A | N/A | Maximum age in seconds before a score is considered stale. | [`DEFAULT_STALENESS_WINDOW_SECS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L95) |
| `CooldownSecs` | Instance | N/A | N/A | Rate limit cooldown delay between submissions for the same key. | [`DEFAULT_COOLDOWN_SECS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L57) |
| `DecayRateNumerator` | Instance | N/A | N/A | Fixed-point exponential decay numerator λ. Defaults to 0. | [`DEFAULT_DECAY_LAMBDA_NUM`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L113) |
| `DecayRateDenominator` | Instance | N/A | N/A | Fixed-point exponential decay denominator λ. Defaults to 1. | [`DEFAULT_DECAY_LAMBDA_DEN`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L116) |
...
| `ScoreFloorHighWaterMark` | Instance | N/A | N/A | Peak score threshold for reputation laundering protection. | [`DEFAULT_SCORE_FLOOR_HWM`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L143) |
| `ScoreFloorMinValue` | Instance | N/A | N/A | Minimum score allowed once the floor applies. | [`DEFAULT_SCORE_FLOOR_MIN`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L147) |
| `ScoreFloorEnabled` | Instance | N/A | N/A | Global activation state of the score floor policy. Defaults to false. | - |
| `HysteresisMargin` | Instance | N/A | N/A | Margin used to widen the exit threshold below the risk threshold. Defaults to 0. | [`MAX_HYSTERESIS_MARGIN`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L167) |
| `ConsensusThresholdK` | Instance | N/A | N/A | Minimum model submissions that must agree for consensus. | [`DEFAULT_CONSENSUS_THRESHOLD_K`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L194) |
| `ConsensusEpsilon` | Instance | N/A | N/A | Maximum absolute deviation from the provisional median allowed. | [`DEFAULT_CONSENSUS_EPSILON`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L197) |
| `GateCallers` | Instance | N/A | N/A | List of contract addresses authorized to call gate functions. | - |

---

### Persistent Storage Keys
*All persistent keys in Stellar Lense share the same TTL bounds.*
* **TTL Threshold**: `SCORE_TTL_THRESHOLD` (~30 days / 518,400 ledgers)
* **TTL Extend-To**: `SCORE_TTL_EXTEND_TO` (~45 days / 777,600 ledgers)

| Key Name | Storage Tier | TTL Threshold | TTL Extend-To | Description | Cross-Reference |
| :--- | :--- | :---: | :---: | :--- | :--- |
| `Score(Address, Symbol)` | Persistent | 518,400 | 777,600 | Holds the latest `RiskScore` struct for a (wallet, asset_pair). | [`SCORE_TTL_THRESHOLD`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L2), [`SCORE_TTL_EXTEND_TO`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L3) |
...
| `AssetPairs(Address)` | Persistent | 518,400 | 777,600 | List of asset pairs (`Vec<Symbol>`) a wallet is tracked on. | [`MAX_WALLET_PAIRS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L45) |
...
| `PausedPairIndex` | Persistent | 518,400 | 777,600 | Incrementally maintained list (`Vec<Symbol>`) of paused pairs. | [`MAX_PAUSED_PAIRS`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L103) |
...
| `Counterparties(Address, Symbol)` | Persistent | 518,400 | 777,600 | Bidirectional links list (`Vec<Address>`) for wallet graphing. | [`MAX_COUNTERPARTY_LINKS_PER_WALLET`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L130) |
...
| Key Name | Storage Tier | TTL Threshold | TTL Extend-To | Description | Cross-Reference |
| :--- | :--- | :---: | :---: | :--- | :--- |
| `RiskBandState(Address, Symbol)` | Temporary | 518,400 | 777,600 | Records if a wallet is in the high-risk band for an asset pair. | [`BAND_STATE_TTL_THRESHOLD`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L171), [`BAND_STATE_TTL_EXTEND_TO`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L175) |
| `ScoreEmbargo(Address)` | Temporary | 1,555,200 | 3,110,400 | Regulatory embargo details (`EmbargoExpiry`). Expire threshold is ~90 days; target extend-to is ~180 days. | [`EMBARGO_TTL_THRESHOLD`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L186), [`EMBARGO_TTL_EXTEND_TO`](file:///c:/Users/HP/Desktop/opensource/Stellar-Lense/contracts/stellar-lense-score/src/constants.rs#L189) |

---

## Aggregator Storage Keys (stellar-lense-aggregator)
...
`invariants::invariant_check(env)` in `contracts/stellar-lense-score/src/invariants.rs`.
...
`contracts/stellar-lense-score/src/test_migration_rollback.rs`.
...
**New public methods on `StellarLenseAggregator`:**

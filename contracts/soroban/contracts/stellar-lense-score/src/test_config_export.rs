...
use crate::{
    parameter_governance::param_key_cooldown, StellarLenseScoreContract, StellarLenseScoreContractClient,
};

const START_TS: u64 = 1_700_000_000;

fn setup<'a>() -> (Env, StellarLenseScoreContractClient<'a>, Address, Address, Address) {
    let env = Env::default();
    env.mock_all_auths();

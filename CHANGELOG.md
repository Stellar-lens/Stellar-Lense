...
- **Rustdoc example for `get_finality_buffer`**: Added a runnable usage example demonstrating the default value (`0`) and reading back a configured buffer (closes #945).
